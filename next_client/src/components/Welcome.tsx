            ...
            <div className="flex lg:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col lg:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the crypto world. Buy and sell cryptocurrencies easily on DYYCP.
                    </p>
                    {!currentAccount && (
                        <button
                            type="button"
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full  mt-10">
                    <div className=" w-full p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-[22rem] my-5 eth-card .white-glassmorphism ">
